    ...
    describe('Proposal Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/proposals';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Proposal', () => {
                service.create(new Proposal(null)).subscribe(received => {
            ...
            it('should update a Proposal', () => {
                service.update(new Proposal(123)).subscribe(received => {
